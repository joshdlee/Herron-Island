      ...
      <View style={styles(theme).schedule}>
        <ScrollView>
          {Object.keys(holidaySchedule).map((holidayName, index) => {
            ...
            const holidayWithDate = holidayNameWithoutDate
              .split("_")
                    ...
                    {islandDepartureTimes.map((time, index) => {
                      return (
                        <Row
                          ...
                          data={[time]}
                          widthArr={[
                            StyleSheet.flatten(styles(theme).tableColumn).width,
                          ]}
                          style={[
                      ...
                      {mainlandDepartureTimes.map((time, index) => {
                        return (
                          <Row
                            ...
                            data={[time]}
                            widthArr={[
                              StyleSheet.flatten(styles(theme).tableColumn)
                                .width,
                            ]}
                            style={[
                              styles(theme).tableRow,
